...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='tadosettings',
            options={'verbose_name': 'Tado configuration', 'default_permissions': ()},
        ),
